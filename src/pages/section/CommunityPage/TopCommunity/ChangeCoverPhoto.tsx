...
const ChangeCoverPhoto:React.FC<props>=({setPreviewImage,community,role})=>{
    ...
    const handleUpload=async()=>{
        ...
        if(file){
            ...
            formData.append("communityId",community.communityId.toString())
        } 
        try {
            const data=await CommunityService.changeCoverPhoto(formData);
            setFile(null)
